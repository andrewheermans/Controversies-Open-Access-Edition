---
layout: post
title:  "Chapter 6: Analyzing Evidence"
...
## Chapter Assignment
Play Evidence Bingo! In small groups, using the cards below (or cards you make up yourselves), read several articles out loud. Every time someone spots a kind of evidence, shout out its name. If you have a square on your card that lists the name of that kind of evidence, put an X on the square. The first person to have three in a row wins!
